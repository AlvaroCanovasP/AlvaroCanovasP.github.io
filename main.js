...
document.addEventListener('DOMContentLoaded', function () {
    const imageDetails = [
        ...
        { src: "img/Xavier-Guillen-Viz-4.webp", fit: "cover", mobileFit: "contain", type: "image" },
        { src: "img/Anells-Triptic+logo.webp", fit: "cover", mobileFit: "cover", type: "image" },
        { src: "img/Julia-Spinola-Invite-Color-1 copy.webp", fit: "cover", mobileFit: "cover", type: "image" },
